...
open class CropImageView @JvmOverloads constructor(
    ...
    fun cropAndSaveImage(
        ...
        val imageState = ImageState(
            ...
            currentScale, currentAngle, isFlipHorizontally())
    ...
    open fun postFlip() {
        ...
        mCurrentImageMatrix.postScale(-1f, 1f, mCropRect.centerX(), mCropRect.centerY())
        ...
        if (mBitmapLaidOut && !isImageWrapCropBounds) {
            ...
            if (animate) {
                post(WrapCropBoundsRunnable(
                    ...
                    currentScale,
                    deltaScale,
                    willImageWrapCropBoundsAfterTranslate).also { mWrapCropBoundsRunnable = it })
            } else {
    ...
    protected fun zoomImageToPosition(
        ...
        post(ZoomImageToPosition(this@CropImageView,
            ...
            deltaScale,
            centerX,
            centerY).also { mZoomImageToPositionRunnable = it })
    }

    private fun calculateImageScaleBounds() {
        val drawable = drawable ?: return
        calculateImageScaleBounds(drawable.intrinsicWidth.toFloat(),
