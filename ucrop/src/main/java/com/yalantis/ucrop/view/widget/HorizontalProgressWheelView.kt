...
class HorizontalProgressWheelView : View {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawLine(mCanvasClipBounds.centerX().toFloat(),
    ...
    private fun init() {
        mMiddleLineColor =
            ContextCompat.getColor(context, R.color.ucrop_color_black)
        mProgressLineWidth =
        ...
        mProgressLinePaint!!.color = resources.getColor(R.color.ucrop_color_white)
